...
describe('klados-do-worker', () => {
  ...
  beforeAll(async () => {
    ...
    // Requires *:invoke permission for the klados to act on this collection.
    ...
    // Create test entity with sufficient content (job.ts requires at least 50 chars)
  ...
  it('should process entity and create output', async () => {
    ...
    // Verify expected log messages (from job.ts)
